...
namespace GameSystem.GameScene.MainMenu
{
    ...
    public class UIGenerator : MonoBehaviour
    {
        ...
        public void Generate()
        {
            ...
            // Create MainUIController
            GameObject controllerGo = new GameObject("MainUIController");
            controllerGo.transform.SetParent(transform, false);
            MainUIController controller = controllerGo.AddComponent<MainUIController>();
            ...
            // 1. Main Panel
            controller.mainPanel = CreatePanel<MainUIMainPanel>(panelsRect, "MainPanel");
            ...
            controller.singlePlayerPanel = CreatePanel<MainUISinglePlayerPanel>(panelsRect, "SinglePlayerPanel");
            ...
            // 4. Login Panel
            controller.loginPanel = CreatePanel<MainUIMultiplayerLoginPanel>(panelsRect, "LoginPanel");
            ...
            // 5. Lobby Panel
            controller.lobbyPanel = CreatePanel<MainUIMultiplayerLobbyPanel>(panelsRect, "LobbyPanel");
            ...
            // 6. Room Panel
            controller.roomPanel = CreatePanel<MainUIMultiplayerRoomPanel>(panelsRect, "RoomPanel");
