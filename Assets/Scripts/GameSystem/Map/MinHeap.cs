...
namespace GameSystem.GameScene.MainMenu.Map
{
    ...
    public class MinHeap<T>
    {
        ...
        private void MinHeapDown(int index)
        {
            while (true)
            {
                var left = 2 * index + 1; // 左子节点索引
                var right = 2 * index + 2; // 右子节点索引
                var smallest = index; // 当前最小元素的索引
